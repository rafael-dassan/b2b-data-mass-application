...
public enum AndroidCapabilities implements MobileApplication {
    ...
    private static DesiredCapabilities getCapabilitiesAndroid() {
        ...
        String zoneNameOfApp = ReadJsonFile.getInfoInsideJsonByPath(new String[]{"zone-name"});
        caps.setCapability("app",System.getProperty("user.dir")+"/src/test/java/app/"+StaticVariable.getZone().toLowerCase()+"/app.apk");
        caps.setCapability("appPackage", "com.abinbev.android.tapwiser."+zoneNameOfApp+".sit");
