...
def input_free_good_to_cart_calculation_v2(deal_id, accounts, zone, environment, skus, minimum_quantity, quantity):
    ...
    dict_values = {
        ...
        "deals[0].output.freeGoods.freeGoods[1].skus[0].sku": product_sku,
        "deals[0].output.freeGoods.freeGoods[1].skus[0].price": skus[0]['price'],
        "deals[0].output.freeGoods.freeGoods[1].skus[1].sku": product_sku,
        "deals[0].output.freeGoods.freeGoods[1].skus[1].price": skus[0]['price'],
    }
