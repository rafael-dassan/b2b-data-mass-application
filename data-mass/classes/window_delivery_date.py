...
class window_delivery_date(QMainWindow):

    def __init__(self, current_date):
        super().__init__()

        # setting title
        self.setWindowTitle("Delivery Date Selector ")

        # setting geometry
        self.setGeometry(100, 100, 600, 400)

        #creating first label
        self.label_1 = QLabel('The current delivery date of your order is:', self)
        ...
        self.label_1 = QLabel('Select the new delivery date:', self)
        # setting font and size
        self.label_1.setFont(QFont('Arial', 15))
        self.label_1.setAlignment(Qt.AlignCenter)
