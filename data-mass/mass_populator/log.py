...
class Message(Enum):
    ...
    RETRIEVE_RECOMMENDER_SELL_UP_ERROR = "Fail on retrieve recommendation type sell up for account {account_id}."
    DELETE_RECOMMENDER_SELL_UP_ERROR = "Fail on delete recommendation type sell up for account {account_id}."
