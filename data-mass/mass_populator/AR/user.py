...
def populate_user(environment, username, password, account_ids):
    if "success" != create_user_ar(environment, username, password, account_ids[0]):
        logger.error("Fail on populate user.")
    else:
        for account_id in account_ids[1:]:
            associate_user_ar(environment, username, password, account_id)


def associate_user_ar(environment, username, password, account_id):
    country = "AR"
...
def create_user_ar(environment, username, password, account_id):
    country = "AR"
